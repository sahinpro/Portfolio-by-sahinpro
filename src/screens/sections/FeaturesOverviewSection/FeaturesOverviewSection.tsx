...
const pricingPlans = [
  {
    name: "Starter Plan",
    description:
      "Perfect for small businesses and startups who need a professional online presence.",
    price: "$500",
  ...
  },
  {
    name: "Pro Plan",
    description:
      "For growing businesses who want advanced features, e-commerce capabilities, and better performance.",
    price: "$1,500",
    buttonText: "Get Started",
    features: [
  ...
  },
  {
    name: "Elite Plan",
    description:
      "For enterprises who need a complete digital solution with custom features and dedicated support.",
    price: "$3,500",
    buttonText: "Get Started",
    features: [
