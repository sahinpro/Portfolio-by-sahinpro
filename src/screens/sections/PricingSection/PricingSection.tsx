...
export const PricingSection = (): JSX.Element => {
  return (
    <section className="flex flex-col container mx-auto items-center gap-12 px-4 py-12  relative">
      ...
      <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-5 w-full container mx-auto relative z-10 px-4 sm:px-0">
       <ChromaGrid />
      </div>
    </section>
  );
