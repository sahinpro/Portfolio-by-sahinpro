...
export const WhyChooseUsSection = (): JSX.Element => {
  return (
    <section className="flex flex-col container mx-auto items-center gap-12 px-4 py-10 sm:px-8 lg:px-12 lg:py-14 relative">
      <motion.div
        className="flex flex-col w-full items-center gap-12 relative z-10"
        initial="hidden"
        whileInView="visible"
      ...
      >
        <motion.div
          variants={fadeInUp}
          className="flex flex-col w-full container mx-auto items-center gap-5"
        >
        ...
        <motion.div
          variants={fadeInUp}
          className="flex flex-col sm:flex-row items-stretch sm:items-center gap-5 w-full container mx-auto px-0 lg:px-4"
        >
          <ChromaGrid />
        </motion.div>
      </motion.div>
