...
const faqItems = [
  {
    ...
    answer:
      "Cryptofi gives you real-time insights, smart alerts, and faster execution built for active traders not just basic price tracking.",
  },
  {
    question: "Is my data and wallet information safe?",
    answer: "",
  },
  {
    question: "Which wallets and exchanges can I connect?",
    answer: "",
  },
  {
...
export const CryptoDashboardSection = (): JSX.Element => {
  return (
