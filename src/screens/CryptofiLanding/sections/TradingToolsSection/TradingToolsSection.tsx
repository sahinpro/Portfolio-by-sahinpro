...
export const TradingToolsSection = (): JSX.Element => {
  return (
    <section className="flex flex-col w-full max-w-[1440px] mx-auto items-center gap-12 px-[100px] py-[100px] relative">
