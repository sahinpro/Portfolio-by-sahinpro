...
const testimonials = [
  {
    ...
    logo: "/icon-1.svg",
    quote:
      "Adopting Cryptofi has enhanced our trading efficiency, slashing transaction times by half. Our clients can now make trades continuously without interruptions.",
    author: {
      name: "Sara Kim",
...
export const WhyChooseUsSection = (): JSX.Element => {
  return (
    <section className="relative flex flex-col items-center gap-[66px] p-[100px] w-full max-w-[1440px] mx-auto">
      <img
      ...
      <header className="flex flex-col items-center gap-5 w-full max-w-[1240px] relative z-10">
        ...
        <div className="flex flex-col gap-4 items-center w-full">
          <h2 className="bg-[linear-gradient(180deg,rgba(255,255,255,1)_0%,rgba(255,255,255,0.9)_100%)] [-webkit-background-clip:text] bg-clip-text [-webkit-text-fill-color:transparent] [text-fill-color:transparent] [font-family:'Inter_Display-Medium',Helvetica] font-medium text-5xl text-center tracking-[-1.00px] leading-[56.0px]">
          ...
          <p className="w-full max-w-[656px] [font-family:'Inter_Display-Regular',Helvetica] font-normal text-[#b3b3b3] text-xl text-center tracking-[-0.20px] leading-[32.0px]">
            Hear from developers and teams who've transformed their workflows
            and accelerated their success with our platform.
          </p>
        </div>
      </header>
