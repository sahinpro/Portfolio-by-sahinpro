...
const headingClass =
  "section-heading [font-family:'Inter_Display-Medium',Helvetica] font-medium text-2xl sm:text-3xl md:text-4xl lg:text-5xl tracking-[-1.00px] leading-tight sm:leading-[40px] md:leading-[48px] lg:leading-[56px]";
