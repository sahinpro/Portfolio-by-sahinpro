  ...
  return (
    ...
    >
      <PublicImage
        ...
        height={40}
        priority
        sizes="40px"        className="w-9 h-9 sm:w-10 sm:h-10 rounded-[10px] object-cover border-2 border-white/20 shadow-md ring-1 ring-white/10 transition-transform duration-200 group-hover:scale-105"
      />
    </Link>
  );
};
